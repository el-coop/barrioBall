                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Your request to join <a
                                                href="{{ action('Match\MatchController@showMatch', $match) }}">{{ $match->name }}</a>
                                        was accepted.</p>
                                    @if($userMessage && $userMessage != '')
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">{{ $manager->username }}
                                            says:</p>
                                    ...
                                    @endif
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        You can reply to this message by replying to this email.</p>
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    If you’re having trouble clicking the match link, copy and paste the
                                                    URL below
                                                    into your web browser: <a
                                                            href="{{ action('Match\MatchController@showMatch', $match) }}"
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{ action('Match\MatchController@showMatch', $match) }}</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
